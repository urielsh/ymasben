# `studio management system' - AngularJs system for a small yoga studio client management.

## Getting Started

To get you started you can simply clone the `ymas` repository and install the dependencies:

### Prerequisites

You need git and permission to clone the `ymas` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `ymas`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `ymas`

Clone the `ymas` repository using git:

```
git clone https://bitbucket.org/urielsha/ymas.git
cd ymas
```
...
'ymas' changes this location through the `.bowerrc` file. Putting it in the `app` folder
...
There are two kinds of tests in the 'ymas' application: Unit tests and end-to-end tests.

### Running Unit Tests

The `ymas` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
